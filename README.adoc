...
* gradle-build.yml +
  trigger the gradle jib build for creating the images configured the buildSrc
...
[source]
----
  # delete the resource group and logout from az:
  azure.bash delete

  # setup the k8s cluster
  azure.bash create

  # bootup the k8s dashboard
  azure.bash dashboard
